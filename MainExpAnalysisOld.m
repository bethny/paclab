...
%% OLD SORTING
%             RH_NC_Ans_key_old = [RH_NC_Ans_key_old targID(RH_NC_idx{b-1,s})]; % len = 96; 24/block * 4 blocks
%             RH_NC_Rsp_key = [RH_NC_Rsp_key rspKey(RH_NC_idx)];
%             RH_C_Ans_key = [RH_C_Ans_key targID(RH_C_idx)];
%             RH_C_Rsp_key = [RH_C_Rsp_key rspKey(RH_C_idx)];
%             LH_NC_Ans_key = [LH_NC_Ans_key targID(LH_NC_idx)];
%             LH_NC_Rsp_key = [LH_NC_Rsp_key rspKey(LH_NC_idx)];
%             LH_C_Ans_key = [LH_C_Ans_key targID(LH_C_idx)];
%             LH_C_Rsp_key = [LH_C_Rsp_key rspKey(LH_C_idx)];